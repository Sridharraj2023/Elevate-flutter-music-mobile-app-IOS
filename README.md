...
- **Workflow file:** `/.github/workflows/build_ios.yml`
- **Triggers:** runs on pushes to `main` and on every pull request.
- **Output:** unsigned `.ipa` artifact generated by `flutter build ipa --no-codesign`.
